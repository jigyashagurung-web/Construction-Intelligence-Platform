...
Entering and maintaining BOQ items via a catalog-driven WBS code picker, with derived description/unit fields, denormalized catalog data on each item, and a simplified item entry form (no Trade or Status fields).
