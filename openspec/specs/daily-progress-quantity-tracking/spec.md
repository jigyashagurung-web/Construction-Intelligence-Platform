# daily-progress-quantity-tracking

## Purpose

Recording, validating, and aggregating quantity consumed per daily progress (site diary) entry, and deriving activity percent-complete from it for activities linked to a BOQ item.
